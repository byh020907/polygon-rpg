...
export const ART_DIRECTION_ROWS = [
  [
    '기준 스타일',
    '정돈된 레오곡 계열의 2D 액션 RPG 시각 언어. 작은 캐릭터와 넓은 세계, 안정된 실루엣, 단순하고 명확한 vector/polygon, 작은 머리와 긴 가는 팔다리, 큰 면의 3~4단계 셀 명암. 특정 작품의 캐릭터 복제나 러프하고 삐뚤빼뚤한 손그림은 지양합니다.',
  ],
  [
    '생활형 산업 세계',
    '사람들이 오래된 설비를 고쳐 쓰며 생업을 이어가는 왕국입니다. 낡음=멸망, 고철=쓰레기, 기계=디스토피아가 아닙니다. 옛 군수 규격은 생활 기계에 남은 잠금·인장·접속 방식입니다.',
  ],
  [
    '화면과 전투',
