...
- REF-01 선택된 외형 보강 2안은 인물 전용 presentation recipe에서 굵은 외곽선과 두 단계 명암을 적용한다. 큰 실루엣 선과 내부 디테일 선을 구분하고, 어두운 배경에서 읽히도록 두 명암 단계의 최저 밝기를 명시한다. recipe는 master의 부위·좌표·접촉·anchor를 변경하지 않으며 게임과 검토실이 공유한다.
