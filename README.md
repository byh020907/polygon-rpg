...
- 전체 그래픽 검토: `http://127.0.0.1:5173/?graphicsReview=1` — 메인 메뉴의 POLYGON RPG 제목 또는 게임의 MENU/MAP을 1초 길게 눌러 디버그 패널에서도 연다. 지도 해금 전부터 사용할 수 있다. [등록·검토 안내](./docs/graphics-review.md)
