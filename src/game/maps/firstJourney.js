...
export const FIRST_JOURNEY_ROOMS = Object.freeze([
  {
    id: 'field-crossing',
    label: '노을풀밭 갈림길',
    bounds: { x: 4336, y: 0, width: FIELD_ROOM_WIDTH, height: 540 },
  ...
  },
  {
    id: 'field-canopy',
    label: '실습림 수관 우회로',
    bounds: { x: 5576, y: 0, width: FIELD_ROOM_WIDTH, height: 540 },
    cameraAnchor: { x: 480, y: 270 },
    groundY: fieldGroundY,
    movementBounds: { minX: 24, maxX: 1176 },
    renderOrder: 30,
  ...
  },
  {
    ...
    bounds: { x: 6816, y: 0, width: 1200, height: 540 },
    cameraAnchor: { x: 480, y: 270 },
  ...
  },
  {
    ...
    label: '봉인 회랑 · 숨은 잔향실',
    signatureRule: FIRST_JOURNEY_DUNGEON_SIGNATURE_RULE,
    bounds: { x: 13016, y: 0, width: 760, height: 540 },
  ...
  },
  {
    ...
    label: '폐쇄 실습림 · 봉인 핵',
    bounds: { x: 8056, y: 0, width: 1024, height: 540 },
    cameraAnchor: { x: 480, y: 270 },
    groundY: bossGroundY,
