...
export const SCRAP_OWNER_CAST_ENTITY_ID = 'cast-scrapyard-owner';
export const SCRAP_RIVAL_DEPARTURE_CAST_ENTITY_ID = 'cast-rival-departure';
export const SCRAP_RIVAL_YARD_CAST_ENTITY_ID = 'cast-rival-yard';
export const SCRAP_RIVAL_TRAPPED_CAST_ENTITY_ID = 'cast-rival-trapped';
export const SCRAP_RIVAL_RESCUED_CAST_ENTITY_ID = 'cast-rival-rescued';
export const SCRAP_RIVAL_RETURN_CAST_ENTITY_ID = 'cast-rival-return';
...
const renderItems = [
  ...
  item(
    ...
    '#43464b',
    {
      ...
      order: 17,
      enabled: false,
      label: '라이벌 갈고리를 붙잡은 회수팔 집게',
      role: 'retrieval-arm',
      materialId: 'metal',
    },
  ),
  item('scrap-retrieval-arm-grab-signal', rectangle(1046, 238, 12, 9), '#e0a04a', {
    stroke: '#5a3a1a',
    lineWidth: 2,
    order: 20,
    enabled: false,
    label: '회수팔 가동 신호등',
    role: 'retrieval-arm-signal',
    materialId: 'metal',
    emissive: true,
  }),
...
const SCRAP_AWAKENING_RAW_MAP = {
      ...
      rooms: [
        {
          ...
          entities: [
            {
              id: SCRAP_OWNER_CAST_ENTITY_ID,
              kind: 'cast-character',
              actorId: 'scrapyard-owner',
              position: { x: 198, y: 344 },
              facing: 1,
              presentationProfileId: 'scrapyard-owner',
              bodyProfileId: 'owner',
              motionId: 'idle',
              dialogueAnchorOffset: { x: 0, y: -72 },
            },
            {
              id: SCRAP_RIVAL_DEPARTURE_CAST_ENTITY_ID,
              kind: 'cast-character',
              actorId: 'rival-scout',
              position: { x: 431, y: 344 },
              facing: 1,
            ...
            {
              id: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
              kind: 'cast-character',
              actorId: 'rival-scout',
              position: { x: 677, y: 344 },
              facing: 1,
              presentationProfileId: 'rival-scout',
              bodyProfileId: 'rival',
              motionId: 'idle',
            ...
            {
              id: SCRAP_RIVAL_TRAPPED_CAST_ENTITY_ID,
              kind: 'cast-character',
              actorId: 'rival-scout',
              position: { x: 1030, y: 344 },
              facing: -1,
              presentationProfileId: 'rival-scout',
              bodyProfileId: 'rival',
              motionId: 'knocked-out',
              dialogueAnchorOffset: { x: 0, y: -42 },
              enabled: false,
            },
            {
              id: SCRAP_RIVAL_RESCUED_CAST_ENTITY_ID,
              kind: 'cast-character',
              actorId: 'rival-scout',
              position: { x: 1030, y: 344 },
              facing: -1,
            ...
            {
              id: SCRAP_RIVAL_RETURN_CAST_ENTITY_ID,
              kind: 'cast-character',
              actorId: 'rival-scout',
              position: { x: 620, y: 344 },
              facing: -1,
              presentationProfileId: 'rival-scout',
              bodyProfileId: 'rival',
              motionId: 'run',
            ...
            {
              id: SCRAP_RIVAL_SURVEY_GUIDE_ENTITY_ID,
              kind: 'story-interaction',
              position: { x: 975, y: 354 },
              interactionRange: 76,
              autoStart: true,
              autoStartRange: 64,
              speaker: SCRAP_CAST.RIVAL.name,
              lines: [
                '두 번째 유닛은 멈췄어. 저기 끊긴 구조 줄 받침까지 같이 가자. 흔들리면 네 방패 뒤로 붙을게.',
                '받침 표식을 내가 붙일 테니 넌 줄이 어디서 끊겼는지 봐 줘. 점검만 하고 안쪽으로 가자.',
              ],
              presentationProfileId: 'rival-scout',
              presentationMode: 'ambient',
              enabled: false,
            },
            {
              ...
              presentationProfileId: 'rival-scout',
              scrapAwakeningNextStageId: SCRAP_AWAKENING_STAGE.YARD_APPROACH,
              enabled: false,
            },
            {
              id: 'scrap-yard-approach-collector',
              kind: 'combat-enemy',
            ...
            {
              id: SCRAP_RIVAL_PLATE_GUIDE_ENTITY_ID,
              kind: 'story-interaction',
              position: { x: 1112, y: 354 },
              interactionRange: 76,
              autoStart: true,
              autoStartRange: 64,
              speaker: SCRAP_CAST.RIVAL.name,
              lines: [
                '경계 유닛은 멈췄어. 저기 떨어진 흉갑 조각까지 같이 가자. 흔들리면 네 방패 뒤로 붙을게.',
                '조각 표식을 내가 붙일 테니 넌 연결 줄이 어디서 내려앉았는지 봐 줘. 점검만 하고 흉곽 아래로 가자.',
              ],
              presentationProfileId: 'rival-scout',
              presentationMode: 'ambient',
              enabled: false,
            ...
            {
              id: SCRAP_PLAYER_SEARCH_NOTICE_ENTITY_ID,
              kind: 'story-interaction',
              position: { x: 1188, y: 354 },
              interactionRange: 76,
              autoStart: true,
              autoStartRange: 36,
              speaker: SCRAP_CAST.PROTAGONIST.monologueName,
              lines: [
                '흉곽 아래 통로는 버티는데, 저 회수팔이 아까부터 같은 각도로만 움직여.',
                '수거 표식보다 오래된 지지대야. 건드리기 전에 라이벌이랑 같이 확인하자.',
              ],
            ...
            },
            {
              ...
              lines: [
                ...
                '내가 앞 연결 줄을 볼 테니 넌 방패를 들고 그대로 와. 흔들리면 바로 뒤로 빠져.',
              ],
              presentationProfileId: 'rival-scout',
              presentationMode: 'ambient',
              enabled: false,
      ...
      rooms: [
        {
          ...
          entities: [
            ...
            {
              id: 'mine-rival-scout-cast',
              kind: 'cast-character',
              actorId: 'rival-scout',
              position: { x: 1090, y: 344 },
              facing: -1,
              presentationProfileId: 'rival-scout',
              bodyProfileId: 'rival',
              motionId: 'idle',
      ...
      rooms: [
        {
          ...
          entities: [
            ...
            {
              id: 'greenhouse-rival-scout-cast',
              kind: 'cast-character',
              actorId: 'rival-scout',
              position: { x: 1090, y: 344 },
              facing: -1,
  ...
  patches: [
    ...
    },
    {
      ...
      operations: [
        { op: 'set-enabled', target: SCRAP_RIVAL_DEPARTURE_CAST_ENTITY_ID, value: true },
    ...
    },
    {
      ...
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 540, y: 344 } },
        },
      ...
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 790, y: 344 } },
        },
        { op: 'set-enabled', target: SCRAP_RIVAL_WALK_ENTITY_ID, value: true },
      ...
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 870, y: 344 } },
        },
        { op: 'set-enabled', target: SCRAP_RIVAL_WALK_ENTITY_ID, value: true },
      ...
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 1012, y: 344 } },
        },
        { op: 'set-enabled', target: SCRAP_RIVAL_WALK_ENTITY_ID, value: true },
        { op: 'set-enabled', target: SCRAP_RIVAL_SURVEY_GUIDE_ENTITY_ID, value: true },
    ...
    {
      id: 'scrap-prologue-yard-approach',
      priority: 7,
      when: { fact: 'scrapAwakeningStageId', eq: SCRAP_AWAKENING_STAGE.YARD_APPROACH },
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 1038, y: 344 } },
        },
        { op: 'set-enabled', target: SCRAP_RIVAL_WALK_ENTITY_ID, value: true },
        ...
        { op: 'set-enabled', target: 'scrap-retrieval-arm-dormant-forearm', value: true },
        { op: 'set-enabled', target: 'scrap-retrieval-arm-dormant-claw', value: true },
        { op: 'set-enabled', target: 'scrap-yard-approach-collector', value: true },
      ],
    },
    {
      ...
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 1160, y: 344 } },
        },
        { op: 'set-enabled', target: SCRAP_RIVAL_WALK_ENTITY_ID, value: true },
        { op: 'set-enabled', target: SCRAP_RIVAL_PLATE_GUIDE_ENTITY_ID, value: true },
        { op: 'set-enabled', target: 'scrap-yard-winch-base', value: true },
        { op: 'set-enabled', target: 'scrap-yard-winch-base-mark', value: true },
        { op: 'set-enabled', target: 'scrap-yard-chest-plate-mark', value: true },
      ...
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 1196, y: 344 } },
        },
        { op: 'set-enabled', target: SCRAP_RIVAL_WALK_ENTITY_ID, value: true },
      ...
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 1244, y: 344 } },
        },
        { op: 'set-enabled', target: SCRAP_RIVAL_WALK_ENTITY_ID, value: true },
      ...
      operations: [
        {
          op: 'override',
          target: SCRAP_RIVAL_YARD_CAST_ENTITY_ID,
          override: { enabled: true, position: { x: 1332, y: 344 } },
        },
        { op: 'set-enabled', target: SCRAP_RIVAL_WALK_ENTITY_ID, value: true },
    ...
    },
    {
      ...
      operations: [
        { op: 'set-enabled', target: SCRAP_RIVAL_TRAPPED_CAST_ENTITY_ID, value: true },
        { op: 'set-enabled', target: 'scrap-retrieval-arm-grab-upper', value: true },
        { op: 'set-enabled', target: 'scrap-retrieval-arm-grab-claw', value: true },
        { op: 'set-enabled', target: 'scrap-retrieval-arm-grab-signal', value: true },
    ...
    },
    {
      ...
      operations: [{ op: 'set-enabled', target: SCRAP_RIVAL_RESCUED_CAST_ENTITY_ID, value: true }],
    },
    {
    ...
    },
    {
      ...
      operations: [
        { op: 'set-enabled', target: SCRAP_RIVAL_RETURN_CAST_ENTITY_ID, value: true },
    ...
    },
    {
      ...
      operations: [
        { op: 'set-enabled', target: SCRAP_MINE_RIVAL_SCOUT_ENTITY_ID, value: true },
        { op: 'set-enabled', target: 'mine-rival-scout-cast', value: true },
      ],
    },
    {
    ...
    },
    {
      ...
      operations: [
        ...
        { op: 'set-enabled', target: 'mine-rival-scout-cast', value: false },
    ...
    },
    {
      ...
      operations: [
        ...
        { op: 'set-enabled', target: 'shipyard-rival-scout-cast', value: true },
      ],
    },
    {
    ...
    },
    {
      ...
      operations: [
        ...
        { op: 'set-enabled', target: 'shipyard-rival-scout-cast', value: false },
    ...
    },
    {
      ...
      operations: [
        ...
        { op: 'set-enabled', target: 'greenhouse-rival-scout-cast', value: true },
      ],
    },
    {
    ...
    },
    {
      ...
      operations: [
        ...
        { op: 'set-enabled', target: 'greenhouse-rival-scout-cast', value: false },
    ...
    },
    {
      ...
      operations: [
        { op: 'set-enabled', target: SCRAP_SNOW_RIVAL_SCOUT_ENTITY_ID, value: true },
        { op: 'set-enabled', target: 'snow-rival-scout-cast', value: true },
      ],
    },
    {
    ...
    },
    {
      ...
      operations: [
        ...
        { op: 'set-enabled', target: 'snow-rival-scout-cast', value: false },
    ...
    },
    {
      ...
      operations: [
        { op: 'set-enabled', target: SCRAP_QUARRY_RIVAL_SCOUT_ENTITY_ID, value: true },
        { op: 'set-enabled', target: 'quarry-rival-scout-cast', value: true },
      ],
    },
    {
    ...
    },
    {
      ...
      operations: [
        ...
        { op: 'set-enabled', target: 'quarry-rival-scout-cast', value: false },
